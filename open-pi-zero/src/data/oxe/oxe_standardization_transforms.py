...
def fractal_interleave_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    import tensorflow_graphics.geometry.transformation as tft
...
def fanuc_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]: # new version
    trajectory["observation"]["proprio"] = trajectory["observation"]["state"]
    return trajectory

def openx_interleave_pretrain_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    trajectory["observation"]["proprio"] = trajectory["observation"]["state"]
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "open_x_berkeley_autolab_ur5_interleave": openx_interleave_pretrain_transform,
    "open_x_iamlab_cmu_pickup_insert_interleave": openx_interleave_pretrain_transform,
    "open_x_stanford_hydra_interleave": openx_interleave_pretrain_transform,
    "open_x_austin_sirius_interleave": openx_interleave_pretrain_transform,
    "open_x_bridge_interleave": openx_interleave_pretrain_transform,
    "open_x_jaco_play_interleave": openx_interleave_pretrain_transform,
    "open_x_ucsd_kitchen_interleave": openx_interleave_pretrain_transform,
    "open_x_bc_z_interleave": openx_interleave_pretrain_transform,
    "open_x_fractal20220817_interleave": openx_interleave_pretrain_transform,
    "open_x_language_table_interleave": openx_interleave_pretrain_transform,
    "open_x_utaustin_mutex_interleave": openx_interleave_pretrain_transform,
}
